...
class SharedPrefs {
  ...
  Future<bool> putDouble(String key, double value) =>_prefs.setDouble(key, value);
  ...
  Future<bool> putString(String key, String value) => _prefs.setString(key, value);

  String getString(String key) => _prefs.getString(key);

  Future<bool> putStringList(String key, List<String> value) =>  _prefs.setStringList(key, value);
